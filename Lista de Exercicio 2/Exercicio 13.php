...
<body>
    <div class="container py-3">
        <form method="post">
            <div class="mb-3">
                <label for="num1" class="form-label fw-bold">Digite o valor em metros: </label>
        ...
        {//método usado para requisição.
            $metros = $_POST['metros'];//leio 1 campo do formulario
            $centimetros = $metros * 100;
            echo "$metros metros em centímetros é: $centimetros cm.";
        }
        ?>
