...
<body>
    <div class="container py-3">
        <form method="post">
            <div class="mb-3">
                <label for="num1" class="form-label fw-bold">Digite o valor em quilômetros: </label>
        ...
        {//método usado para requisição.
            $km = $_POST['km'];//leio 1 campo do formulario
            $milhas = $km * 0.6214;
            echo "$km quilômetros em milhas é: $milhas milhas.";
        }
        ?>
