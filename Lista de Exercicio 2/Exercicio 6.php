...
<body>
    <div class="container py-3">
        <form method="post">
            <div class="mb-3">
                <label for="num1" class="form-label fw-bold">Digite a temperatura em graus Celsius: </label>
        ...
        {//método usado para requisição.
            $Celsius = $_POST['TempC'];//leio 1 campo do formulario
            $TempF = ($Celsius * 1.8)+32;
            echo "A temperatura em Fahrenheit: $TempF";
        }
        ?>
