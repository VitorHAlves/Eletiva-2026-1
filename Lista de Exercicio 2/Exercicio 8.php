...
<body>
    <div class="container py-3">
        <form method="post">
            <div class="mb-3">
                <label for="num1" class="form-label fw-bold">Digite a altura do retângulo: </label>
                <input type="number" id="altura" name="altura" class="form-control" required="">
            </div>
            <div class="mb-3">
                <label for="num2" class="form-label fw-bold">Digite a largura do retângulo: </label>
        ...
        {//método usado para requisição.
            $alturaR = $_POST['altura'];//leio 1 campo do formulario
            $larguraR = $_POST['largura'];//leio outro campo do formulário
            $area = $alturaR * $larguraR;
