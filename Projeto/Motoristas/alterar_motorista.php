<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try{
            ...
            if ($stmt->execute([$nome,$data_nasc,$cpf,$email,$telefone,$cnh,$id]))
            {
                    ...
                    <form method="post">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <input value="<?= $resultado['data_nascimento'] ?>" type="date" id="data_nasc" name="data_nasc" class="form-control" required="">
                            </div>
                        </div>
                        ...
                        <div class ="row g-3 mb-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <input value="<?= $resultado['cnh'] ?>" type="number" id="cnh" name="cnh" class="form-control" required="">
                            </div>
                        </div>
